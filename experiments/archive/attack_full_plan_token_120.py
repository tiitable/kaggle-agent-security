...
def _single_profile(
    ...
    *,
    max_verified: int = 60,
    empty_fallback: int = 40,
    search_fraction: float = 0.04,
    max_search_s: float = 60.0,
    max_msg_chars: int = 400,
    calibration_order: str = "stratified",
    replay_hop_cap: int = 0,
    calibration_fraction: float = 0.20,
    mutation_fraction: float = 0.30,
    mass_fraction: float = 0.80,
    single_fraction: float = 0.95,
    deputy_fraction: float = 0.97,
    destructive_fraction: float = 0.99,
    combo_pool_size: int = 6,
    fill_pool_size: int = 30,
    mutation_seed_limit: int = 3,
) -> dict[str, Any]:
    return _profile(
        max_verified_candidates=max_verified,
        return_target_candidates=return_target,
        static_fallback_candidates=static_fallback,
        empty_run_fallback_candidates=empty_fallback,
        ...
        replay_hop_cap=replay_hop_cap,
        min_return_candidates=min_return,
        calibration_fraction=calibration_fraction,
        mutation_fraction=mutation_fraction,
        mass_fraction=mass_fraction,
        single_fraction=single_fraction,
        deputy_fraction=deputy_fraction,
        destructive_fraction=destructive_fraction,
        combo_pool_size=combo_pool_size,
        fill_pool_size=fill_pool_size,
        mutation_seed_limit=mutation_seed_limit,
    )
...
PROFILE_SETTINGS = {
    "probe_40": _profile(
        ...
        return_target_candidates=40,
        static_fallback_candidates=40,
    ...
    "multi4_500": _profile(
        ...
        static_fallback_candidates=260,
        empty_run_fallback_candidates=40,
        search_fraction=0.01,
        max_search_s=45.0,
        endpoint_counts=(4, 2, 1),
        ...
        mutation_seed_limit=1,
        force_payload_balance=True,
        split_fill_fraction=0.06,
    ),
    "shape_probe_120": _profile(
        ...
        calibration_fraction=0.92,
        mutation_fraction=0.94,
        mass_fraction=0.96,
        single_fraction=0.98,
    ...
    "winner_shapes_160": _profile(
        max_verified_candidates=80,
        return_target_candidates=160,
        ...
        default_max_hops=4,
        calibration_order="endpoint_outer",
        min_return_candidates=160,
        calibration_fraction=0.86,
        mutation_fraction=0.88,
        mass_fraction=0.96,
        single_fraction=0.96,
        deputy_fraction=0.99,
        destructive_fraction=0.995,
        combo_pool_size=80,
        fill_pool_size=80,
        mutation_seed_limit=0,
        calibration_variant_names=("tool_call_plan", "fewshot_batch", "json_batch"),
        allow_deputy_fill=False,
    ),
    "fewshot_token_160": _profile(
        max_verified_candidates=80,
        return_target_candidates=160,
        static_fallback_candidates=160,
        empty_run_fallback_candidates=40,
        ...
        calibration_variant_names=("fewshot_batch",),
        allow_deputy_fill=False,
    ),
    "plan_token_120": _profile(
        max_verified_candidates=80,
        return_target_candidates=120,
        static_fallback_candidates=120,
        empty_run_fallback_candidates=40,
    ...
    "single_breadth_360": _single_profile(
        360,
        180,
        320,
        max_verified=220,
    ...
    "single_breadth_450": _single_profile(
        450,
        220,
        390,
        max_verified=260,
    ...
    "single_breadth_500": _single_profile(
        500,
        500,
        360,
        max_verified=80,
    ...
    "guide16_single_600": _single_profile(600, 300, 400),
    "single_640": _single_profile(640, 320, 440),
    "single_680": _single_profile(680, 340, 460),
    "single_720": _single_profile(720, 360, 480),
    "single_760": _single_profile(760, 380, 500),
    "hybrid_private_760": _single_profile(
        760,
        420,
        500,
        max_verified=80,
        ...
        combo_pool_size=36,
        fill_pool_size=72,
        mutation_seed_limit=2,
    ) | {
        "deputy_probe_limit": 6,
        "deputy_mutation_limit": 2,
        "force_payload_balance": True,
        "split_fill_fraction": 0.15,
    },
}
